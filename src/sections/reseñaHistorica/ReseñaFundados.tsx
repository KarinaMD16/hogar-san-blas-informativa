...
const ReseñaFundados = () => {
  ...
  return (
    <section
        ...
        className="bg-cover bg-center bg-no-repeat min-h-[300px] sm:min-h-[400px] md:min-h-[500px] lg:min-h-[600px] h-[35vh] sm:h-[40vh] md:h-[60vh] lg:h-[70vh] text-white"
    >
        ...
        <div className="absolute flex flex-col items-baseline w-9/10 sm:w-4/5 text-left gap-1 sm:gap-14 top-30 sm:top-40 left-4 sm:left-5 px-0">
            ...
            <p className="font-opensans text-white text-sm sm:text-base md:text-lg w-full">
                {reseña.descripcion[0]}
            </p>
            <p className="hidden sm:block font-opensans text-white sm:text-base md:text-lg sm:w-full">
