...
const ReseñaFundados = () => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute flex flex-col items-center w-full sm:w-4/5 text-center gap-6 sm:gap-10 md:gap-12 lg:gap-14 xl:gap-16 top-30 sm:top-24 md:top-28 lg:top-32 xl:top-36 left-1/2 -translate-x-1/2 sm:left-4 sm:translate-x-0 md:left-6 lg:left-8 xl:left-10 px-2 sm:px-4 md:px-6 lg:px-8 xl:px-15">
