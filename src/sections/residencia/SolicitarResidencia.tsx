...
const SolicitarResidencia = () => {
  const {contentJson } = useContext(IdiomaContext);
    ...
    return (
        <section style={{ backgroundImage: `linear-gradient(rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(${contentJson.solicitudResidencia.imagen})`}} 
           ...
           >
            ...
            <div>
                ...
                <span className="font-medium text-base text-md md:text-base lg:text-lg">{contentJson.solicitudResidencia.botonRequisitos}</span>
                </Boton>
            </div>
            </div>
        </section>
