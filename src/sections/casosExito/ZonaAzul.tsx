...
const ZonaAzul = () => {
  ...
  return (
    <section className="bg-white mb-0 md:mb-55 lg:mb-20 xl:mb-8 py-6 lg:py-12 flex flex-col px-4 xl:px-25">
        ...
        <div className="flex max-h-80 flex-col md:flex-row justify-left gap-8 lg:gap-12">
            ...
            <div className="flex flex-col justify-evenly md:w-1/2 xl:w-180 gap-8 text-left">
                <p className="text-lg">
