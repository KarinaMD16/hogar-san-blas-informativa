        ...
        {(field: {
          ...
          <div className="mb-4">
            <Label className="block text-left text-sm font-medium mb-6">
              {placeholders.tipoVoluntariado.label} <span className="text-red-600">*</span>
            </Label>
            {loadingTipos ? (
        ...
        {(field: { state: { value: any; }; handleChange: (arg0: number) => void; }) => (
          <div className="mb-4">
            <Label className="block text-left text-sm font-medium mb-2">
              {placeholders.tipoVoluntariado.horas} <span className="text-red-600">*</span>
            </Label>
            <InputField
              id="cantidadHoras"
              type="number"
              min="0"
              step="1"
              placeholder={placeholders.tipoVoluntariado.placeholder}
